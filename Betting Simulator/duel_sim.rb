#Runs 2 competing sims at once using similar logic to the betting_simulator
...
class Duel
    ...
    def upload(profit_1, profit_2, winner)
        begin
            con = PG.connect :dbname => 'db_name', :user => 'username'
            con.exec "INSERT INTO table_name (profit_1, profit_2, winner) VALUES (#{profit_1}, #{profit_2}, #{winner})"
        rescue PG::Error => e
            puts e.message
        ensure
            con.close if con
